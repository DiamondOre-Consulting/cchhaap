  ...
  return (
    <div className="min-h-screen text-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6">
          This Privacy Policy describes how Chhaapp Collection (collects, uses,
          and discloses your personal information when you visit, use our
          services, or make a purchase from priyankascollection.in (the "Site")
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <li>
            ...
            saved into your account like loyalty points, reviews, referrals or
        ...
        <ul className="list-disc pl-6 mb-6 space-y-4">
          ...
          <li>
            <span className="font-medium">Marketing and Advertising.</span> We
        ...
        <p className="mb-6">
          ...
          above in "How we Collect and Use your Personal Information" and "How
