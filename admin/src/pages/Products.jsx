...
const Products = () => {
  ...
  },
  {
    ...
    inputType: "select",
    required: true,
    options: ["Cotton", "Silk", "Rayon", "Polyester", "Linen", "Wool", "Blended", "Other"],
    validation: {
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              >
                ...
                <div class="ps-3  text-wrap">
                  <div class="text-base font-semibold">Beige Organza Saree</div>
                </div>
              </th>
              ...
              <td class="px-6 py-4">
                <p className="gap-x-4 flex text-xl">
                  ...
                  <MdOutlineDeleteOutline onClick={()=> setDeletePopUp(true)} className="cursor-pointer hover:text-red-600" />
                </p>
              </td>
            </tr>
          </tbody>
