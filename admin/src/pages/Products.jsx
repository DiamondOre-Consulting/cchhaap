...
import { adminSearchProduct, deleteProduct, getAllProduct } from "@/Redux/Slices/productSlice";
...
const Products = () => {
  ...
  const handleGetAllProducts = async (page=1 , limit =itemsPerPage) => {
    const res = await dispatch(getAllProduct({limit , page}));
  ...
  try {
      setIsSearching(true);
      const res = await dispatch(adminSearchProduct(query));
        ...
        <div className="relative overflow-x-auto mt-10 shadow-md sm:rounded-lg">
          ...
          {isSearching ? (
            ...
            <>
                  ...
                  {productData?.products?.length > 0 ? (
                    productData.products.map((product, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">{product?.category?.categoryName}</td>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            {product?.isActive ? (
                              ...
                              <div className="h-2.5 w-2.5 rounded-full bg-red-800 me-2"></div>
                            )}
              ...
              {!searchQuery && productData.totalPages > 1 && (
